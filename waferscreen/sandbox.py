from waferscreen.scripts import sweep_to_find_resonances, check_out, band_sweeps, ResFinder
...
res_fit = ResFinder(file=sweep_file, group_delay=31.839, verbose=True, freq_units="GHz", auto_process=True)
